...
prashant_image = face_recognition.load_image_file('faces/prashant.png')
prashant_encoding = face_recognition.face_encodings(prashant_image)[0]

known_face_encodings = [prince_encoding, prashant_encoding]
known_face_names = ['Prince', 'Prashant']
